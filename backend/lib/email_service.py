...
async def send_appointment_emails(
    ...
    # Shared email head & styles for perfectly identical sizing across all devices
    email_head = """
    <head>
      <meta charset="utf-8">
      ...
      <style>
        ...
        @media only screen and (max-width: 600px) {
          .email-wrapper { width: 100% !important; padding: 8px 4px !important; }
          .email-card { width: 100% !important; max-width: 100% !important; border-radius: 8px !important; }
          .header-cell { padding: 22px 16px !important; }
    ...
    <body style="margin:0; padding:0; background-color:#F2F0EB; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
      <table role="presentation" class="email-wrapper" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; margin:0; padding:16px 8px; background-color:#F2F0EB;">
        <tr><td align="center" style="padding:0;">
          <table role="presentation" class="email-card" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px; width:100%; background:#FFFFFF; border-radius:12px; overflow:hidden; border:1px solid #D6CDBC;">

            <!-- Gold Accent -->
            <tr><td style="height:4px; background:linear-gradient(90deg,#C9956B,#D4A373,#C9956B);"></td></tr>

            <!-- Header -->
            <tr><td class="header-cell" style="background:#164D59; padding:26px 20px; text-align:center;">
              <img src="{AMEYA_LOGO_URL}" alt="Ameya Consultancy" width="56" height="56" style="border-radius:50%; border:2px solid #D4A373; background:#FFFDF8; display:block; margin:0 auto 10px auto;" />
              <div style="font-size:21px; font-weight:700; color:#FFFFFF; letter-spacing:-0.3px;">Ameya Consultancy</div>
            ...
            <!-- Body -->
            <tr><td class="body-cell" style="padding:28px 24px;">
              <div style="display:inline-block; background:#DFF5EE; color:#0A6B5E; font-size:12px; font-weight:700; padding:5px 14px; border-radius:16px; margin-bottom:16px;">✓ CONFIRMED</div>

              <h2 style="color:#1A1A2E; font-size:21px; font-weight:700; margin:10px 0 8px 0;">Hello {patient_name},</h2>
              <p style="font-size:15px; line-height:1.65; color:#333333; margin:0 0 22px 0;">
              ...
              <!-- Appointment Card -->
              <table role="presentation" class="info-card" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#F9F7F2; border:1px solid #E2DBCC; border-radius:10px; overflow:hidden;">
                <tr><td style="padding:16px 18px 10px 18px; border-bottom:1px dashed #D6CDBC;">
                ...
                <tr><td style="padding:14px 18px;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td style="padding:6px 0; font-size:14px; color:#555555; width:40%;">Consultation Type</td>
              ...
              {f'''
              <!-- Meet Link -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:22px; background:#EDF7F5; border:1px solid #B0D9CF; border-radius:10px;">
                <tr><td style="padding:20px 18px; text-align:center;">
                  ...
                  <div style="font-size:13px; color:#444444; margin-bottom:14px;">Encrypted &amp; powered by Google Meet</div>
                  <a href="{meeting_url}" style="display:inline-block; background:#0E776C; color:#FFFFFF; font-weight:700; font-size:15px; text-decoration:none; padding:12px 30px; border-radius:8px;">Join Google Meet</a>
                  <div style="margin-top:10px; font-size:12px; word-break:break-all;"><a href="{meeting_url}" style="color:#0E776C;">{meeting_url}</a></div>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:22px; background:#F9F7F2; border:1px solid #E2DBCC; border-radius:10px;">
              ...
              <!-- Preparation Tips -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:22px; border-left:4px solid #D4A373; background:#FDFBF6; border-radius:0 8px 8px 0;">
                <tr><td style="padding:14px 16px;">
                  <div style="font-size:12px; font-weight:700; text-transform:uppercase; letter-spacing:1px; color:#7A5C3A; margin-bottom:6px;">📋 Before Your Consultation</div>
                  <div style="font-size:13px; line-height:1.65; color:#333333;">
              ...
              <p style="margin-top:24px; font-size:13px; color:#555555; text-align:center;">
                Need to reschedule? Call <strong style="color:#164D59;">{CLINIC_PHONE}</strong>
              </p>
            </td></tr>

            <!-- Footer -->
            <tr><td style="background:#F5F2EC; padding:20px 24px; text-align:center; border-top:1px solid #E2DBCC;">
    ...
    if attachment_filenames:
        ...
        reports_html = f"""
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:20px; background:#EDF7F5; border:1px solid #B0D9CF; border-radius:10px; overflow:hidden;">
          <tr><td style="padding:12px 14px; font-size:12px; font-weight:700; color:#0A6B5E; text-transform:uppercase; letter-spacing:1px; border-bottom:1px solid #C5E0D8;">
          ...
          <tr><td style="padding:10px 14px; font-size:12px; color:#0A6B5E; font-weight:600;">
      ...
      <table role="presentation" class="email-wrapper" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; margin:0; padding:16px 8px; background-color:#F2F0EB;">
        <tr><td align="center" style="padding:0;">
          <table role="presentation" class="email-card" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px; width:100%; background:#FFFFFF; border-radius:12px; overflow:hidden; border:1px solid #D6CDBC;">
            ...
            <!-- Body -->
            <tr><td class="body-cell" style="padding:28px 24px;">
              <div style="display:inline-block; background:#E0ECF0; color:#164D59; font-size:12px; font-weight:700; padding:5px 14px; border-radius:16px; margin-bottom:16px;">⚡ NEW BOOKING</div>

              <h2 style="color:#1A1A2E; font-size:21px; font-weight:700; margin:10px 0 8px 0;">Hello Dr. Nisha,</h2>
              <p style="font-size:15px; line-height:1.65; color:#333333; margin:0 0 22px 0;">
                ...
                <tr><td style="padding:14px 18px;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                      ...
                      <td style="padding:7px 0; font-size:14px; font-weight:700; border-bottom:1px solid #EDEAD9; word-break:break-all;"><a href="mailto:{patient_email}" style="color:#164D59; text-decoration:none;">{patient_email}</a></td>
                    </tr>
                    <tr>
              ...
              <!-- Patient Notes -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:20px; border-left:4px solid #164D59; background:#F9F7F2; border-radius:0 8px 8px 0;">
                <tr><td style="padding:14px 16px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:22px; background:#EDF7F5; border:1px solid #B0D9CF; border-radius:10px;">
                <tr><td style="padding:20px 18px; text-align:center;">
                  ...
                  <div style="font-size:12px; color:#0A6B5E; font-weight:600; margin-bottom:12px;">✓ Auto-synced to your Google Calendar</div>
                  <a href="{meeting_url}" style="display:inline-block; background:#0E776C; color:#FFFFFF; font-weight:700; font-size:15px; text-decoration:none; padding:12px 30px; border-radius:8px;">Start / Join Consultation</a>
                  <div style="margin-top:10px; font-size:12px; word-break:break-all;"><a href="{meeting_url}" style="color:#0E776C;">{meeting_url}</a></div>
                </td></tr>
              </table>
